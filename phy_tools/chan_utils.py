...
def gen_do_file(path, Mmax, gen_2X, chan_name, exp_tuple, inbuff_tuple, pfb_tuple, down_tuple, final_cnt_name):
    ...
    exp_name, cic_name, cic_fifo, slicer_name, exp_fifo = exp_tuple
    ...
    with open(file_name, 'w') as fh:
        ...
        fh.write('catch {{\n')
        fh.write('    design.dependencies.add channelizer_top.v xfft_sim_netlist.vhd\n')
        fh.write('}}\n')
        fh.write('\n')
        ...
        fh.write('\n')
        fh.write('design.file.add $PROJ_SRC/{}.v\n'.format(chan_name))
        fh.write('design.file.add $PROJ_TB_SRC/{}_tb.v\n'.format(chan_name))
        fh.write('\n')
